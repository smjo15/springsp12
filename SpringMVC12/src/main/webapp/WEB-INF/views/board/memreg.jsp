...
<body>
  ...
  <div class="card">
    ...
    <div class="card-body">
	 ...
	 <div class="col-lg-7">
		<form action="${cpath}/login/memreg" method="post">
          ...
          <div class="form-group">
             <label>비밀번호</label>
             <input name="memPwd" id="memPwd" class="form-control" >
          </div>
           <div class="form-group">
             <label>회원이름</label>
             <input name="memName" class="form-control">
          </div>             
      	<span id="error" style="color: red"></span>
        <div align="center">
          <button type="reset" class="btn btn-secondary btn-sm">취소</button>
          <button type="submit" class="btn btn-secondary btn-sm btn-info">회원가입</button>
